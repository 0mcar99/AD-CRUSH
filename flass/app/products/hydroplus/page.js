...
import Navbar from '@/components/hydropulse/Navbar';
import Footer from '@/components/hydropulse/Footer';
import Reveal from '@/components/hydropulse/Reveal';
import Tilt3D from '@/components/hydropulse/Tilt3D';
import CountUp from '@/components/hydropulse/CountUp';
import BeforeAfter from '@/components/hydropulse/BeforeAfter';
import ScrollCinema from '@/components/hydropulse/ScrollCinema';
import VideoEmbed from '@/components/hydropulse/VideoEmbed';
import PricingCard from '@/components/hydropulse/PricingCard';
...
export default function Home() {
  ...
  // Product quantity state for buying model descaler cards
  ...
  return (
    <main className={styles.main}>
          ...
          <Reveal delay={0.75}>
            ...
            >
              ...
              <div className={styles.pdfTextContainer}>
                <span className={styles.pdfSubtext}>CLICK HERE TO DOWNLOAD</span>
                <span className={styles.pdfTitleText}>HydroPulse.PDF</span>
              </div>
            </a>
          </Reveal>
        </div>
      ...
      <section className={styles.painSection} style={{ borderTop: '1px solid var(--border)', background: 'rgba(255, 107, 0, 0.01)' }}>
      ...
      <section id="how-it-works" style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.05)', paddingBottom: '120px' }}>
      ...
      <section id="pricing" className={styles.painSection}>
        ...
        <div className={styles.productGrid}>
          ...
          <Reveal delay={0.1}>
            <div className={styles.productCard}>
              <div className={styles.productImgContainer}>
                <img 
                  src="/images/marlin_blue.png" 
                  alt="HydroPulse Marlin 1.0" 
                  className={styles.productImg}
                />
              </div>
              <div className={styles.productContent}>
                <h3 className={styles.productTitle}>Marlin 1.0</h3>
                <p className={styles.productDesc}>
                  Perfect limescale control for apartments and medium bungalows (1-inch pipe lines). Prevents scales and maintains healthy water.
                </p>
                <div className={styles.productBadges}>
                  <span className={styles.badgeSize}>Size: 1 inch</span>
                ...
                <div className={styles.productActions}>
                  <div className={styles.qtySelector}>
                    <button className={styles.qtyBtn} onClick={() => handleUpdateQuantity('marlin-1', -1)}>-</button>
                    <span className={styles.qtyDisplay}>{quantities['marlin-1']}</span>
                    <button className={styles.qtyBtn} onClick={() => handleUpdateQuantity('marlin-1', 1)}>+</button>
                  </div>
                  <button 
          ...
          <Reveal delay={0.25}>
            <div className={styles.productCard}>
              <div className={styles.productImgContainer}>
                <img 
                  src="/images/marlin_white.png" 
                  alt="HydroPulse Marlin Pro" 
                  className={styles.productImg}
                />
              </div>
              <div className={styles.productContent}>
                <h3 className={styles.productTitle}>Marlin Pro</h3>
                <p className={styles.productDesc}>
                  Reinforced signal loop for villas, penthouses, and light corporate setups (1.5-inch lines). Ideal for larger scale volumes.
                </p>
                <div className={styles.productBadges}>
                  <span className={styles.badgeSize}>Size: 1.5 inch</span>
                  <span className={styles.badgeStock}>In stock</span>
                </div>
                <div className={styles.productPriceBlock}>
                  <span className={styles.priceLabel}>Price</span>
                ...
                <div className={styles.productActions}>
                  <div className={styles.qtySelector}>
                    <button className={styles.qtyBtn} onClick={() => handleUpdateQuantity('marlin-pro', -1)}>-</button>
                    <span className={styles.qtyDisplay}>{quantities['marlin-pro']}</span>
                    <button className={styles.qtyBtn} onClick={() => handleUpdateQuantity('marlin-pro', 1)}>+</button>
                  </div>
                  <button 
                    className={styles.btnAddToCart}
          ...
          {/* HydroPulse Industrial Card */}
          <Reveal delay={0.4}>
            <div className={styles.productCard}>
              <div className={styles.productImgContainer}>
                <img 
                  src="/images/industrial_descaler.png" 
                  alt="HydroPulse Industrial" 
                  className={styles.productImg}
                />
              </div>
              <div className={styles.productContent}>
                <h3 className={styles.productTitle}>HydroPulse Industrial</h3>
                <p className={styles.productDesc}>
                  Heavy-duty descaling unit for high-flow main pipelines, factories, manufacturing plants, cooling towers, and commercial complexes.
                </p>
                <div className={styles.productBadges}>
                ...
                <div className={styles.productActions}>
                  <div className={styles.qtySelector}>
                    <button className={styles.qtyBtn} onClick={() => handleUpdateQuantity('marlin-industrial', -1)}>-</button>
                    <span className={styles.qtyDisplay}>{quantities['marlin-industrial']}</span>
                    <button className={styles.qtyBtn} onClick={() => handleUpdateQuantity('marlin-industrial', 1)}>+</button>
                  </div>
                  <button 
                    className={styles.btnAddToCart}
                    onClick={() => handleSelectProduct({ id: 'marlin-industrial', title: 'HydroPulse Industrial', price: 79999 }, quantities['marlin-industrial'])}
                  >
                    <ShoppingCart size={16} />
                    <span>Add to Cart</span>
                  </button>
        ...
        {/* Customizable Statement notice below the grid */}
        <Reveal delay={0.45}>
          ...
          <Reveal delay={0.15}>
            <div className={styles.submitFormCard}>
              ...
              <form onSubmit={handleAddReview} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <button type="submit" className={styles.btnPrimary} style={{ padding: '14px', width: '100%', gap: '8px' }}>
          ...
          <div className={styles.drawerBody}>
            {isRedirecting ? (
              ...
              <div style={{ textAlign: 'center', margin: '40px auto 20px auto', display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'center' }}>
                ...
                <button className={styles.btnPrimary} style={{ marginTop: '20px', width: '100%' }} onClick={closeSuccessPopup}>
                  Continue Browsing
                </button>
              </div>
            ) : cart.length === 0 ? (
